...
type FileUploadParams struct {
	...
	// This field is a request body variant, only one variant field can be set.
	OfFileUploadV1ByURL *FileUploadParamsBodyFileUploadV1ByURL `json:",inline"`
...
// The properties File, FileName are required.
type FileUploadParamsBodyFileUploadV1ByURL struct {
	...
	// Array of extensions to be applied to the image. Each extension can be configured
	// with specific parameters based on the extension type.
	Extensions []FileUploadParamsBodyFileUploadV1ByURLExtensionUnion `json:"extensions,omitzero"`
	// Array of response field keys to include in the API response body.
	//
	// Any of "tags", "customCoordinates", "isPrivateFile", "embeddedMetadata",
	// "isPublished", "customMetadata", "metadata".
	...
	//
	// You can mix and match any combination of post-processing types.
	Transformation FileUploadParamsBodyFileUploadV1ByURLTransformation `json:"transformation,omitzero"`
	paramObj
}

func (r FileUploadParamsBodyFileUploadV1ByURL) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURL
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURL) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type FileUploadParamsBodyFileUploadV1ByURLExtensionUnion struct {
	OfRemoveBg          *FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBg          `json:",omitzero,inline"`
	OfAutoTagging       *FileUploadParamsBodyFileUploadV1ByURLExtensionAutoTagging       `json:",omitzero,inline"`
	OfAIAutoDescription *FileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription `json:",omitzero,inline"`
	paramUnion
}

func (u FileUploadParamsBodyFileUploadV1ByURLExtensionUnion) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfRemoveBg, u.OfAutoTagging, u.OfAIAutoDescription)
}
func (u *FileUploadParamsBodyFileUploadV1ByURLExtensionUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *FileUploadParamsBodyFileUploadV1ByURLExtensionUnion) asAny() any {
	if !param.IsOmitted(u.OfRemoveBg) {
		return u.OfRemoveBg
	} else if !param.IsOmitted(u.OfAutoTagging) {
		return u.OfAutoTagging
...
// Returns a pointer to the underlying variant's property, if present.
func (u FileUploadParamsBodyFileUploadV1ByURLExtensionUnion) GetOptions() *FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBgOptions {
	if vt := u.OfRemoveBg; vt != nil {
		return &vt.Options
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u FileUploadParamsBodyFileUploadV1ByURLExtensionUnion) GetMaxTags() *int64 {
	if vt := u.OfAutoTagging; vt != nil {
		return &vt.MaxTags
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u FileUploadParamsBodyFileUploadV1ByURLExtensionUnion) GetMinConfidence() *int64 {
	if vt := u.OfAutoTagging; vt != nil {
		return &vt.MinConfidence
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u FileUploadParamsBodyFileUploadV1ByURLExtensionUnion) GetName() *string {
	if vt := u.OfRemoveBg; vt != nil {
		return (*string)(&vt.Name)
	} else if vt := u.OfAutoTagging; vt != nil {
		return (*string)(&vt.Name)
...
func init() {
	apijson.RegisterUnion[FileUploadParamsBodyFileUploadV1ByURLExtensionUnion](
		"name",
		apijson.Discriminator[FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBg]("remove-bg"),
		apijson.Discriminator[FileUploadParamsBodyFileUploadV1ByURLExtensionAutoTagging]("google-auto-tagging"),
		apijson.Discriminator[FileUploadParamsBodyFileUploadV1ByURLExtensionAutoTagging]("aws-auto-tagging"),
		apijson.Discriminator[FileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription]("ai-auto-description"),
	)
}

// The property Name is required.
type FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBg struct {
	Options FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBgOptions `json:"options,omitzero"`
	// Specifies the background removal extension.
	//
	// This field can be elided, and will marshal its zero value as "remove-bg".
	Name constant.RemoveBg `json:"name,required"`
...
func (r FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBg) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBg
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBg) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBgOptions struct {
	// Whether to add an artificial shadow to the result. Default is false. Note:
	// Adding shadows is currently only supported for car photos.
	AddShadow param.Opt[bool] `json:"add_shadow,omitzero"`
	// Specifies a solid color background using hex code (e.g., "81d4fa", "fff") or
...
func (r FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBgOptions) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBgOptions
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLExtensionRemoveBgOptions) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The properties MaxTags, MinConfidence, Name are required.
type FileUploadParamsBodyFileUploadV1ByURLExtensionAutoTagging struct {
	// Maximum number of tags to attach to the asset.
	MaxTags int64 `json:"maxTags,required"`
	// Minimum confidence level for tags to be considered valid.
	MinConfidence int64 `json:"minConfidence,required"`
...
func (r FileUploadParamsBodyFileUploadV1ByURLExtensionAutoTagging) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLExtensionAutoTagging
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLExtensionAutoTagging) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[FileUploadParamsBodyFileUploadV1ByURLExtensionAutoTagging](
		"name", "google-auto-tagging", "aws-auto-tagging",
	)
}

func NewFileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription() FileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription {
	return FileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription{
		Name: "ai-auto-description",
	}
}

// This struct has a constant value, construct it with
// [NewFileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription].
type FileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription struct {
	// Specifies the auto description extension.
	Name constant.AIAutoDescription `json:"name,required"`
	paramObj
}

func (r FileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLExtensionAIAutoDescription) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// You can mix and match any combination of post-processing types.
type FileUploadParamsBodyFileUploadV1ByURLTransformation struct {
	// Transformation string to apply before uploading the file to the Media Library.
	// Useful for optimizing files at ingestion.
	Pre param.Opt[string] `json:"pre,omitzero"`
	// List of transformations to apply _after_ the file is uploaded.
	// Each item must match one of the following types: `transformation`,
	// `gif-to-video`, `thumbnail`, `abs`.
	Post []FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion `json:"post,omitzero"`
	paramObj
}

func (r FileUploadParamsBodyFileUploadV1ByURLTransformation) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLTransformation
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLTransformation) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}
...
//
// Use [param.IsOmitted] to confirm if a field is set.
type FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion struct {
	OfTransformation *FileUploadParamsBodyFileUploadV1ByURLTransformationPostTransformation `json:",omitzero,inline"`
	OfGifToVideo     *FileUploadParamsBodyFileUploadV1ByURLTransformationPostGifToVideo     `json:",omitzero,inline"`
	OfThumbnail      *FileUploadParamsBodyFileUploadV1ByURLTransformationPostThumbnail      `json:",omitzero,inline"`
	OfAbs            *FileUploadParamsBodyFileUploadV1ByURLTransformationPostAbs            `json:",omitzero,inline"`
	paramUnion
}

func (u FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion) MarshalJSON() ([]byte, error) {
	return param.MarshalUnion(u, u.OfTransformation, u.OfGifToVideo, u.OfThumbnail, u.OfAbs)
}
func (u *FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, u)
}

func (u *FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion) asAny() any {
	if !param.IsOmitted(u.OfTransformation) {
		return u.OfTransformation
	} else if !param.IsOmitted(u.OfGifToVideo) {
		return u.OfGifToVideo
...
// Returns a pointer to the underlying variant's property, if present.
func (u FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion) GetProtocol() *string {
	if vt := u.OfAbs; vt != nil {
		return &vt.Protocol
	}
	return nil
...
// Returns a pointer to the underlying variant's property, if present.
func (u FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion) GetType() *string {
	if vt := u.OfTransformation; vt != nil {
		return (*string)(&vt.Type)
	} else if vt := u.OfGifToVideo; vt != nil {
		return (*string)(&vt.Type)
...
// Returns a pointer to the underlying variant's property, if present.
func (u FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion) GetValue() *string {
	if vt := u.OfTransformation; vt != nil {
		return (*string)(&vt.Value)
	} else if vt := u.OfGifToVideo; vt != nil && vt.Value.Valid() {
		return &vt.Value.Value
...
func init() {
	apijson.RegisterUnion[FileUploadParamsBodyFileUploadV1ByURLTransformationPostUnion](
		"type",
		apijson.Discriminator[FileUploadParamsBodyFileUploadV1ByURLTransformationPostTransformation]("transformation"),
		apijson.Discriminator[FileUploadParamsBodyFileUploadV1ByURLTransformationPostGifToVideo]("gif-to-video"),
		apijson.Discriminator[FileUploadParamsBodyFileUploadV1ByURLTransformationPostThumbnail]("thumbnail"),
		apijson.Discriminator[FileUploadParamsBodyFileUploadV1ByURLTransformationPostAbs]("abs"),
	)
}

// The properties Type, Value are required.
type FileUploadParamsBodyFileUploadV1ByURLTransformationPostTransformation struct {
	// Transformation string (e.g. `w-200,h-200`).
	// Same syntax as ImageKit URL-based transformations.
	Value string `json:"value,required"`
	// Transformation type.
...
func (r FileUploadParamsBodyFileUploadV1ByURLTransformationPostTransformation) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLTransformationPostTransformation
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLTransformationPostTransformation) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The property Type is required.
type FileUploadParamsBodyFileUploadV1ByURLTransformationPostGifToVideo struct {
	// Optional transformation string to apply to the output video.
	// **Example**: `q-80`
	Value param.Opt[string] `json:"value,omitzero"`
	// Converts an animated GIF into an MP4.
...
func (r FileUploadParamsBodyFileUploadV1ByURLTransformationPostGifToVideo) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLTransformationPostGifToVideo
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLTransformationPostGifToVideo) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The property Type is required.
type FileUploadParamsBodyFileUploadV1ByURLTransformationPostThumbnail struct {
	// Optional transformation string.
	// **Example**: `w-150,h-150`
	Value param.Opt[string] `json:"value,omitzero"`
	// Generates a thumbnail image.
...
func (r FileUploadParamsBodyFileUploadV1ByURLTransformationPostThumbnail) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLTransformationPostThumbnail
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLTransformationPostThumbnail) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

// The properties Protocol, Type, Value are required.
type FileUploadParamsBodyFileUploadV1ByURLTransformationPostAbs struct {
	// Streaming protocol to use (`hls` or `dash`).
	//
	// Any of "hls", "dash".
	Protocol string `json:"protocol,omitzero,required"`
...
func (r FileUploadParamsBodyFileUploadV1ByURLTransformationPostAbs) MarshalJSON() (data []byte, err error) {
	type shadow FileUploadParamsBodyFileUploadV1ByURLTransformationPostAbs
	return param.MarshalObject(r, (*shadow)(&r))
}
func (r *FileUploadParamsBodyFileUploadV1ByURLTransformationPostAbs) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

func init() {
	apijson.RegisterFieldValidator[FileUploadParamsBodyFileUploadV1ByURLTransformationPostAbs](
		"protocol", "hls", "dash",
	)
}
