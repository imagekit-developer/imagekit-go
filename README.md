...
```sh
go get -u 'github.com/imagekit-developer/imagekit-go/v2@v2.10.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/imagekit-developer/imagekit-go/v2/option).
