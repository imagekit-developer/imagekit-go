...
func (r *AccountService) GetUsage(ctx context.Context, query AccountGetUsageParams, opts ...option.RequestOption) (res *AccountGetUsageResponse, err error) {
...
type AccountGetUsageResponse struct {
...
func (r AccountGetUsageResponse) RawJSON() string { return r.JSON.raw }
func (r *AccountGetUsageResponse) UnmarshalJSON(data []byte) error {
	return apijson.UnmarshalRoot(data, r)
}

type AccountGetUsageParams struct {
...
// URLQuery serializes [AccountGetUsageParams]'s query parameters as `url.Values`.
func (r AccountGetUsageParams) URLQuery() (v url.Values, err error) {
